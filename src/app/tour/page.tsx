...
export default function Tour() {
  ...
  return (
    <main className="flex-1 flex-col justify-center bg-blue-950/90 px-4 py-10 md:px-12 lg:px-16 text-white">
      ...
      <h1 className="font-semibold text-6xl text-center mt-8">Tour</h1>
      <div className="flex-col divide-y w-full justify-center mt-8 font-light">
        {dates.map((tourDate) => (
